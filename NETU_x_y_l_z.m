...
differencephase_D = k * (x.^2 + y.^2) / 2 / f.^2 * delta_D;
...
imagetarget(13 + 0,7 + 2, 7 + 0, 7 + 1) = 1.3;
imagetarget(13 + 1,7 + 0, 7 + 1, 7 + 2) = 1.18;
imagetarget(13 + 2,7 + 3, 7 + 3, 7 + 1) = 1.3;
imagetarget(13 + 3,7 + 1, 7 + 3, 7 + 3) = 1;  %
imagetarget(13 + 4,7 + 3, 7 + 1, 7 + 2) = 1.18;
imagetarget(13 + 5,7 + 0, 7 + 0, 7 + 2) = 1.18;
imagetarget(13 + 6,7 + 2, 7 + 1, 7 + 3) = 1;  %
...
finalphase = finalphase .* exp(1i * 6.5 * r);
figure;
...
finalphase0 = Uin .* finalphase .* lensphase;
If = zeros(N,N,5);

for ii = 1:30
z = 300 + 4 * ii
a = Fx_CZT_SFFT(finalphase0,N,z,lambda,L0,0.3);
figure;
imagesc(abs(a).^2)
colormap jet
end
Fx_SIM2EXP(finalphase,'rlz.bmp')
