...
delta_A = 4;
delta_B = 3;
delta_D = 12 * lambda * f / L0 / 1;
delta_C = delta_D * 1.2;

differencephase_A = delta_A * r;
differencephase_B = delta_B * theta;
differencephase_C = k * y / z * delta_C;
differencephase_D = k * x / z * delta_D;
...
imagetarget(13 + 3,7 + 2, 7 + 1, 7 + 1) = 1;
imagetarget(13 + 3,7 + 1, 7 + 1, 7 + 1) = 1;

imagetarget(13 + 3,7 + 2, 7 + 1, 7 + 3) = 1;
imagetarget(13 + 3,7 + 3, 7 + 1, 7 + 3) = 1;

imagetarget(13 + 3,7 + 0, 7 + 3, 7 + 2) = 1.6;

imagetarget(13 + 0,7 + 3, 7 + 2, 7 + 2) = 2;

imagetargetESPR = imagetarget(13:13+7,7:7+3,7:7+3,7:7+3);
mappingSpace = Fx_PredictionMAT(imagetargetESPR);
mappingSpace = circshift(mappingSpace,4,7);
mappingSpace = circshift(mappingSpace,4,4);
mappingSpace = circshift(mappingSpace,4,19);
%%
...
Fx_SIM2EXP(finalphase,'FACE.bmp')
