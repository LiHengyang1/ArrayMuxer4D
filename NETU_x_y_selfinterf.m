...
imagetarget(13 + 3,7 + 0, 7 + 1, 7 + 0) = 1.2;
imagetarget(13 + 3,7 + 0, 7 + 0, 7 + 0) = 1.2;

imagetarget(13 + 5,7 + 1, 7 + 2, 7 + 1) = 1.0;
imagetarget(13 + 5,7 + 1, 7 + 1, 7 + 1) = 1.0;

imagetarget(13 + 2,7 + 2, 7 + 1, 7 + 1) = 1.0;
imagetarget(13 + 2,7 + 2, 7 + 3, 7 + 1) = 1.0;

imagetarget(13 + 4,7 + 3, 7 + 0, 7 + 0) = 1;
imagetarget(13 + 4,7 + 3, 7 + 3, 7 + 0) = 1.0;
...
finalphase = finalphase .* exp(1i * -4 * r);
figure;
...
Fx_SIM2EXP(finalphase,'selfinterfere.bmp')
