...
imagetarget(13 + 3,7 + 0, 7 + 1, 7 + 1) = 1.1;
imagetarget(13 + 3,7 + 0, 7 + 0, 7 + 0) = 1.5;

imagetarget(13 + 5,7 + 1, 7 + 2, 7 + 1) = 1.1;
imagetarget(13 + 5,7 + 1, 7 + 1, 7 + 0) = 1.4;

imagetarget(13 + 2,7 + 2, 7 + 1, 7 + 1) = 1.0;
imagetarget(13 + 2,7 + 2, 7 + 3, 7 + 0) = 1.3;

imagetarget(13 + 4,7 + 3, 7 + 0, 7 + 1) = 1;
imagetarget(13 + 4,7 + 3, 7 + 3, 7 + 0) = 1.3;
...
finalphase = finalphase .* exp(1i * 3 * r);
figure;
